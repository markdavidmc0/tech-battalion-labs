...
func (r *ResourceManagerReconciler) ensureDeployment(request reconcile.Request,
...
func (r *ResourceManagerReconciler) backendDeployment(v *mydomainv1alpha1.ResourceManager) *appsv1.Deployment {
