...
func (r *ResourceManagerReconciler) ensureService(request reconcile.Request,
...
func (r *ResourceManagerReconciler) backendService(v *mydomainv1alpha1.ResourceManager) *corev1.Service {
